...
class HystoryLastAnswers {
  static List<List<String>> feedbacks = List.filled(100, List.filled(1, ""));
  static List<int> scores = List.filled(100, -1);
  static List<int> ticketIds = List.filled(100, -1);
  ...
  static Future<void> save() async {
    final prefs = await SharedPreferences.getInstance();
    for (int i = 0; i < feedbacks.length; i++) {
      await prefs.setStringList('hystory_last_feedback_$i', feedbacks[i]);
